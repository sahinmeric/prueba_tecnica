...
def get_min_users():
    ...
    req_min_user = 4  # can be calculated total number of modules to test / number of modules each user uses --> 8/2= 4, or can be iterated between 4 and 20 (length of users)
    ...
    # TODO: Create a loop for req_min_user
    ...
    try:
        ...
        if os.path.exists(min_users_file_name):
            print(f"Minimum user list found. {min_users_file_name} file created")
        else:
